...
//   //understadning the useEffect hook
...
//           {onlineUsers.inlcludes(selectedUser._id)}<span className="w-2 h-2 rounded-full bg-green-500"></span>
//         </p>
//         <img
...
//               <img src={msg.senderId=== authUser._id?assets.avatar_icon: authUser?.profilePic } alt=""  className="w-7 rounded-full"/>
...
//           <input onChange={(e)=>setInput(e.target.value)}  value={input}  onKeyDown={(e)=>e.key==="Enter"?handleSendMessage(e):null} type="text" placeholder="send a message" className="flex-1 text-sm p-3 border-none rounded-lg outline-none text-black placeholder-gray-400" />
