        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
          ...
          <label htmlFor="avatar" className='flex items-center gap-3 cursor-pointer text-white'>
            ...
            <img
              ...
              alt=""
              className={`w-12 h-12 rounded-lg ${selectedImage && 'rounded-full'}`}
            />
            Upload profile picture
          </label>
          ...
          <textarea
           ...
           className='p-2 border border-gray-500 rounded-md focus:outline-none text-primary focus:ring-2 focus:ring-violet-500'
